    ...
    const component = 'wi-row-component',
	    ...
	    classes = {
		    ...
		    drag: {
			    ...
			    twinkling: prefix.drag + 'item-twinkling',
		        ...
		        through: prefix.drag + 'align-line-through',
		        assembled: prefix.drag + 'assembled',
		        dragging: prefix.drag + 'dragging',
		        click: prefix.drag + 'click',
		    },
		    shadow: {
